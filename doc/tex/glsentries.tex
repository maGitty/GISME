...
\newacronym{pe}{PE}{Persistence Pnsemble}
...
\newacronym{arma}{ARMA}{\gls{ar}-Moving Average}
\newacronym{armax}{ARMAX}{\gls{arma} with Exogenous Inputs}
\newacronym{arima}{ARIMA}{\gls{ar} Integrated Moving Average}
...
\newacronym{sr}{SR}{solar radiance}
