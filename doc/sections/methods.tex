...
\Cref{eq:armax} almost equals \Cref{eq:arma} for the \gls{arma} model, but here, there is an additional term $\sum_{k=1}^{n}c_kx_k$ for $n$ included exogenous variables $x$ with $c$ as the respective coefficients.
