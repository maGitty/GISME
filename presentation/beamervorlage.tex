...
\begin{tikzpicture}[node distance=1cm]
  \node (fst) [circle1,label=0:Topic] {1};
...
ARMA/ARMAX performance using different input data and models. % 1 = 168h shifted load, 2 = 2 metre temperature mean over longitude and latitude, 3 = data counter, 4 = weekend dummy, 5 = top 10 regions grid points for 2 metre temperature
